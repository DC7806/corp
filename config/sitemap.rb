...
SitemapGenerator::Sitemap.create do  
  I18n.available_locales.each do |locale|
    group(filename: "sitemap-"+locale.to_s) do
      ...
      ['achievements', 'products','categories','news','contact','faq','about','download','milestones'].each do |page|
      ...
      Achievement.find_each do |achievement|
        add achievement_path(achievement.permalink, locale: locale), 1.month.ago, priority: 0.6, changefreq: 'monthly'
      end
    end
  end
end
